...
#효과음 넣기
attack = pygame.mixer.Sound("C:\\Users\\gggab\\OneDrive\\Desktop\\PythonWorkspace\\pygame_basic\\pygame_project\\sound\\laser_gun.wav")
deadly = pygame.mixer.Sound("C:\\Users\\gggab\\OneDrive\\Desktop\\PythonWorkspace\\pygame_basic\\pygame_project\\sound\\mario_die.wav")
stage_clear = pygame.mixer.Sound("C:\\Users\\gggab\\OneDrive\\Desktop\\PythonWorkspace\\pygame_basic\\pygame_project\\sound\\welcome_sound.wav")
...
#배경 만들기
background = pygame.image.load(resource_path(os.path.join(image_path, "background.png")))

#스테이지 만들기
stage = pygame.image.load(resource_path(os.path.join(image_path, "stage.png")))
...
character_front = pygame.image.load(os.path.join(image_path, "character_front.png"))
...
character_dead = pygame.image.load(os.path.join(image_path, "character_dead.png"))
